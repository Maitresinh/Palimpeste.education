...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "ring-foreground/10 bg-card text-card-foreground gap-2 overflow-hidden rounded-xl py-3 text-xs/relaxed ring-1 has-data-[slot=card-footer]:pb-0 has-[>img:first-child]:pt-0 data-[size=sm]:gap-1 data-[size=sm]:py-2 data-[size=sm]:has-data-[slot=card-footer]:pb-0 *:[img:first-child]:rounded-none *:[img:last-child]:rounded-none group/card flex flex-col",
        className,
      )}
      {...props}
    />
