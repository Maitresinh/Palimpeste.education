CREATE TABLE "document" (
	...
	"filesize" text,
	"mime_type" text DEFAULT 'application/epub+zip' NOT NULL,
...
ALTER TABLE "document" ADD CONSTRAINT "document_group_id_group_id_fk" FOREIGN KEY ("group_id") REFERENCES "public"."group"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "document_ownerId_idx" ON "document" USING btree ("owner_id");--> statement-breakpoint
CREATE INDEX "document_groupId_idx" ON "document" USING btree ("group_id");--> statement-breakpoint
